                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-heading">
                                        <h4 class="h4 text-center p-3 bg-info">Cities Where We Work</h4>
                                    </div>
                                    <div class="card-body">
                                        <div class="form-row">
                                            <div class="col-md-12">
                                                ...
                                                <tbody>
                                                    ...
                                                    while ($row = $userdata->fetch_assoc()):
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <button class="btn btn-info btn-sm" value="<?= $row['cities_id']; ?>"  onclick="editvender(this.value);"><i class="fa fa-edit"></i></button>
                                                                <button class="btn btn-danger btn-sm" value="<?= $row['cities_id']; ?>"  onclick="delete_member_data(this.value);"><i class="fa fa-trash"></i></button>
                ...
                <div class="modal-dialog">  
                    <div class="modal-content">
                        <form action="action.php" method="POST" enctype="multipart/form-data">
                            <div class="modal-header">  
                                <h4 class="modal-title">Add City information</h4>  
                            ...
                            <div class="modal-footer">  
                                ...
                                <button type="submit" name="cities_save" class="btn btn-success btn-sm ">Save</button>
