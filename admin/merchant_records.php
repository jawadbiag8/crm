          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-heading">
                <h4 class="h4 text-center p-3 bg-info">Merchant Records</h4>
              </div>
              <div class="card-body">
              <!-- <div class="form-row">
                <div class="col-md-12">
                ...
                <div class="table-responsive">
                  <table class="table table-striped table-sm table-hover table-bordered table-condenced" id="table_">
                    ...
                    <tbody>
                   <?php 
                   $userdata=$conn->query("SELECT * FROM `tbl_merchant`");
                   $count=0;
                   ...
                   <tr>
                    ...
                    <td>
                    <button class="btn btn-info btn-sm" value="<?=$row['mer_id'];?>"  onclick="editvender(this.value);">Edit</button>
                    <button class="btn btn-danger btn-sm" value="<?=$row['mer_id'];?>"  onclick="delete_member_data(this.value);">Delete</button>
