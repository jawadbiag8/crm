          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-heading">
                <h4 class="h4 text-center p-3 bg-info">Vendors Records</h4>
              </div>
              <div class="card-body">
              <div class="form-row">
                <div class="col-md-12">
                ...
                <div class="table-responsive">
                  <table class="table table-striped table-sm table-hover table-bordered table-condenced" id="table_">
                    ...
                    <tbody>
                   <?php 
                   $userdata=$conn->query("SELECT * FROM `tbl_vendors`");
                   $count=0;
                   ...
                   <tr>
                    ...
                    <button class="btn btn-success btn-sm" value="<?=$row['vendor_id'];?>"  onclick="editvender(this.value);"><i class="fa fa-info"></i> </button>
