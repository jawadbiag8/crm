...
if (isset($_SESSION['admin'])) {
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
        <div class="wrapper">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-heading">
                                        <h4 class="h4 text-center p-3 bg-info">Blogs</h4>
                                    </div>
                                    <div class="card-body">
                                        <div class="form-row">
                                            <div class="col-md-12">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-sm table-hover table-bordered table-condenced" id="table_">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $blogs = $conn->query("SELECT * FROM `tbl_blog`");
                                                    $count = 0;
                                                    while ($row = $blogs->fetch_assoc()):
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?= $row['title']; ?></td>
                                                            <td>
                                                                <!--<button class="btn btn-info btn-sm" value="<?= $row['id']; ?>"  onclick="editvender(this.value);"><i class="fa fa-edit"></i></button>-->
                                                                <button class="btn btn-danger btn-sm" value="<?= $row['id']; ?>"  onclick="delete_member_data(this.value);"><i class="fa fa-trash"></i></button>
            ...
            <div class="modal fade" id="addcategory" role="dialog">  
                <div class="modal-dialog">  
                    <div class="modal-content">  
                        ...
                        <form action="action.php" id="addcategories" enctype="multipart/form-data" method="POST" >
                            <div class="modal-body">  
                                ...
                                <div class="modal-footer">  
                                    ...
                                    <button type="submit" name="addblogcategory" class="btn btn-success btn-sm ">Save</button>
            ...
            <!-- add staff -->
            <div class="modal fade" id="addStaff" style="overflow: scroll" role="dialog">  
                <div class="modal-dialog">  
                    <div class="modal-content">
                        <form action="action.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-body"> 
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <label>Tags</label>
                                            <select class="select2 blogtags" id="tags" name="blogtag[]" multiple="multiple" data-placeholder="Select a Tag" style="width: 100%;">
                                                <?php
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2bs4" id="category" name="blogcategory" style="width: 100%;">
                                                <?php
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Content</label>
                                            <div class="card-body">
                                                <textarea name="blogcontent" id="summernote">
                                                </textarea>
                                            </div>
                                        </div>
                                    </div> 
                                ...
                                <div class="modal-footer">  
                                    <button type="button" class="btn btn-info btn-sm" data-dismiss="modal">Close</button>
                                    <button type="submit" name="saveblog" class="btn btn-success btn-sm ">Save</button>
...
<script>
    ...
    function addblogcategory() {
        ...
        if (categoryname != "") {
            $.ajax({
                url: 'action.php',
                method: 'POST',
                data: {addblogcategory: true, categoryname: categoryname},
                success: function (data) {
                    loadcategory()
                    $("#addStaff").modal('toggle');
                    $("#addcategory").modal('toggle');
    ...
    function loadtags() {
        $.ajax({
            ...
            data: {loadtag: true},
            success: function (data) {
                var hidValue = $("#tags").val();
                $("#tags").html(data);
                var selectedOptions = hidValue;
