          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-heading">
                <h4 class="h4 text-center p-3 bg-info">Orders Pyament Records</h4>
              </div>
              <div class="card-body">
              <!-- <div class="form-row">
                <div class="col-md-12">
                ...
                <div class="table-responsive">
                  <table class="table table-striped table-sm table-hover table-bordered table-condenced" id="table_">
                   ...
                   <tr>
                    ...
                    <td><?=$payment_data['received'];?></td>
                    <td><?=$payment_data['received_able'];?></td>
                    <td><?=$payment_data['paid'];?></td>
                    <td><?=$payment_data['payable'];?></td>
                    <td><?=$payment_data['deductions'];?></td>
                    <td>
                    ...
                    <a href="orders_payment_details.php?p_id=<?=$row['product_id']?>&order_id=<?=$row['order_id']?>">
                      <button class="btn btn-info btn-sm"><i class="fa fa-info"></i></button>
                    </a>
