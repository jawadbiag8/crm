                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-heading">
                                        <h4 class="h4 text-center p-3 bg-info">product Hestory</h4>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-sm table-hover table-bordered table-condenced" id="table_">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $blogs = $conn->query("SELECT d.*,v.vend_name FROM `tbl_products_delete` d JOIN tbl_vendors v on d.vendor_id = v.vendor_id;");
                                                    $count = 0;
