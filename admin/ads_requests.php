          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-heading">
                <h4 class="h4 text-center p-3 bg-info">Ads Request</h4>
              </div>
              <div class="card-body">
                ...
                <div class="table-responsive">
                  <table class="table table-striped table-sm table-hover table-bordered table-condenced" id="table_">
                   ...
                   ?>
                    ...
                    <td>
                    <button class="btn btn-danger btn-sm" value="<?=$row['request_id'];?>"  onclick="delete_member_data(this.value);">Delete</button>
                    <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#edit_<?=$row['request_id'];?>">Edit</button>
                    <div class="modal fade" id="edit_<?=$row['request_id'];?>" role="dialog">  
                            ...
                            <div class="modal-content">  
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        <label for="name">Selected Ads Plan</label>
                                        ...
                                        ?>
                                        <option value="<?=$rw['pkg_id'];?>" <?php if($row['pkg_id']==$rw['pkg_id']){
                                            echo 'selected';
                                        } ?>><?=$rw['pkg_name'].'('.$rw['pkg_prices'].' Rs/) ';?></option>
                                        <?php
                                        endwhile;
                                        ?>
                                    ...
                                    <textarea name="description"  class="form-control" cols="10" rows="3"><?php echo $row['descriptions'];?></textarea>
                                    </div>
                                    <div class="form-group col-md-12">
                                    <label for="">Status</label>
                                    <select name="status" id="" class="form-control" 
                                    onchange="check_Status(this.value);" required>
                                    <option value="">Select Status</option>
                                        <option value="reject">Reject</option>
                                        <option value="accept">Accept</option>
                                    </select>
                                    </div>
                                    <div class="form-group col-md-12 reason_" id="">
                                    <label for="">Rejected Due to (Reason): </label>
                                    <textarea name="reason"  class="form-control" cols="10" rows="3"></textarea>
                                    </div>
                                </div>
                                </div>
                                <div class="modal-footer">  
          <button type="button" class="btn btn-info btn-sm" data-dismiss="modal">Close</button>
          <button type="submit" name="change_request_status" class="btn btn-success btn-sm "> Update</button>
