    ...
    if(!empty($username)){
        ...
        if($rows >0){
            ...
            $recovery_token=$token."&em_=".$username."&_encryption_=".$token;
                ...
                $mail_subject = "Reset Your Password | ZoneElectronics";
                ...
                $mail_message = "
                  ...
                  <a href='https://zoneelectonics.com/vendor/reset-password.php?encrypt=$recovery_token'>Click Here</a>

                  

                  <p>Optional : if button not work please use this link</p>

                  <p>https://zoneelectonics.com/vendor/reset-password.php?encrypt=$recovery_token</p>
                ...
                $headers .= "From: info@ZoneElectronics.com";
