...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link navbar-navy">
      ...
      <img src="../img/favicon.png" alt="ZoneElectronics" class="brand-image img-circle elevation-3" style="opacity: .8">

      <span class="brand-text font-weight-light">ZoneElectronics</span>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        if($_SESSION['support']['role_id']==2){
          ...
          <li class="nav-header">ZoneElectronics Support</li>
        ...
        <li class="nav-header">ZoneElectronics</li>
