            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-heading" style="background: #f0a302">
                        <h4 class="h4 text-center">zone electronics Blog</h4>
                        <h6 class="h6 text-center">Welcome to the world of zone electronics Fashion</h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                $site_url = "https://zoneelectronics.com/blog.php?post=" . $row['id'];
                                ?> 
                                <div id="button_share">
