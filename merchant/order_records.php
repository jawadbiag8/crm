...
if(isset($_SESSION['merchant'])){
  ...
  $merchant_id = $_SESSION['merchant']['mer_id'];
?>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-heading">
                <h4 class="h4 text-center p-3 bg-info">Your Order details</h4>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-striped table-sm table-hover table-bordered table-condenced" id="table_">
                   ...
                   $userdata=$conn->query("SELECT tbl_orders.product_quantity AS quantity, tbl_orders.status as order_status, tbl_orders.*, tbl_products.* FROM tbl_orders INNER JOIN  tbl_products ON tbl_orders.product_id = tbl_products.product_id WHERE tbl_orders.marchant_id = '$merchant_id'");
                   $count=0;
                   ...
                   <tr>
                    ...
                    <td><?php 
                      $get_payment_Rec=$conn->query("SELECT * FROM `tbl_payment_records` where order_id='$row[order_id]'")->fetch_assoc();
                      echo $get_payment_Rec['received'];
                  ...
                  <td>
                     <button class="btn btn-success btn-sm"  data-toggle="modal" data-target="#status_update_<?=$row['order_id']?>">Update Status</button> 
                    <div class="modal fade" id="status_update_<?=$row['order_id']?>" role="dialog">  
                      <div class="modal-dialog modal-lg">  
                        <div class="modal-content">  
                          ...
                          <div class="modal-body" >  
                            <div class="form-row">
                              <div class="form-group col-md-12">
                                <input type="hidden" name="order_id" id="" value="<?=$row['order_id']?>">
                          ...
                          <div class="modal-footer">  
                            ...
                            <button type="submit" name="update_order_status_customer" class="btn btn-success btn-sm ">Update</button>
  ...
  <div class="modal fade" id="addStaff" role="dialog">  
    <div class="modal-dialog modal-lg">  
      ...
      <form action="action.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-footer">  
          <button type="button" class="btn btn-info btn-sm" data-dismiss="modal">Close</button>
          <button type="button" name="add_member" class="btn btn-success btn-sm ">Add Vendors</button>
