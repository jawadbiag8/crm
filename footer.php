            ...
            <div class="col-lg-3 col-md-4">
                ...
                <div class="footer-left">
                    ...
                    <div class="footer-logo">
                        ...
                        <a href="#"><img src="img/footer_logo_n.png" alt="ZoneElectronics"></a>

                    </div>

                    <ul>

                        <li>Address: Office 201, 2nd Floor, Stock Exchange Tower, Blue Area, Islamabad</li>

                        <!-- <li>Phone: +92 51 12345</li> -->

                        <li>

                            <a href="mailto:info@zoneelectonics.com" style="color:#b2b2b2;">

                                Email: info@zoneelectonics.com
                    ...
                    <div class="footer-social">
                        ...
                        <a target="_blank" href="https://www.facebook.com/ZoneElectronicsPlatform"><i class="fa fa-facebook"></i></a>

                        <a href="https://www.linkedin.com/in/kon-jae-846b50220/" target="_blank"><i class="ti-linkedin"></i></a>

                        <a target="_blank" href="https://twitter.com/ZoneElectronicsplatform"><i class="fa fa-twitter"></i></a>

                        <a target="_blank" href="https://www.instagram.com/ZoneElectronicsplatform/"><i class="fa fa-instagram"></i></a>

                            <!-- <a target="_blank" href="https://co.pinterest.com/ZoneElectronicss"><i class="fa fa-pinterest"></i></a> -->
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="copyright-text">
                        ...
                        Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | ZoneElectronics
    ...
    <script>
        ...
        $(function () {
            ...
            Swal.fire({
                ...
                footer: '<a>ZoneElectronics B2B Solutions </a>',
